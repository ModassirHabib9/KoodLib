...
class YourDirectoryStatistics extends StatefulWidget {
  @override
  _YourDirectoryStatisticsState createState() =>
      _YourDirectoryStatisticsState();
}

class _YourDirectoryStatisticsState extends State<YourDirectoryStatistics> {
